...
use "data/poster1.dta", clear

file open p1 using "poster1.json", write
file w p1 "[" _n
...
forval i = 1/`=_N' {
	...
	* section 1: municipal services 
	...
	file w p1 _tab(4) `""personnel": `personnel'"' _n
	file w p1 _tab(3) "}," _n
	...
	* subsection 2.2:
	file w p1 _tab(5) "{" _n
	file w p1 _tab(6) `""label": "Taux de participation aux réunions\nordinaires du Conseil Municipal (%)","' _n
...
use "data/poster2.dta", clear

file open p2 using "poster2.json", write
file w p2 "[" _n
